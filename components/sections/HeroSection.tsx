    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-0">
        <Image
          ...
          priority
          sizes="100vw"
          className="object-cover object-[center_35%] opacity-[0.52] mix-blend-soft-light sm:opacity-[0.46]"
        />
      </div>
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 pb-14 pt-28 sm:px-6 sm:pb-20 sm:pt-32 md:px-10 lg:mx-auto lg:max-w-6xl lg:px-8">
        <div className="max-w-2xl">
          <p className="font-sans text-[11px] font-light uppercase tracking-[0.28em] text-on-dark/90">
          ...
          <p className="mt-5 max-w-xl font-sans text-base leading-relaxed text-on-dark-muted md:text-lg">
            {heroCopy.body}
          </p>
